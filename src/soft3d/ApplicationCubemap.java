...
public class ApplicationCubemap extends JFrame implements ActionListener{	
...
//		gl = new soft3d.v1_0.TinyGLImpl2();
		gl=ShaderCompiler.createProgram("kernels/vertexShaderCubeTex.txt","kernels/fragShaderCubeTex.txt");
		try {
//			gl.texture0=new Texture("D:/用户目录/Pictures/a1.png");
			final Texture[] uCubemap = new Texture[6];
//			 创建cube map
// GLBITMAP* pos_x_img = gTM.GetTextureData("img1/right.jpg"); GLBITMAP* neg_x_img = gTM.GetTextureData("img1/left.jpg");
// GLBITMAP* pos_y_img = gTM.GetTextureData("img1/bottom.jpg");GLBITMAP* neg_y_img = gTM.GetTextureData("img1/top.jpg");
// GLBITMAP* pos_z_img = gTM.GetTextureData("img1/front.jpg"); GLBITMAP* neg_z_img = gTM.GetTextureData("img1/back.jpg");
			String f = f0;
			uCubemap[0]= new Texture(f + "right.jpg");
			uCubemap[1]= new Texture(f + "left.jpg");
			uCubemap[2]= new Texture(f + "bottom.jpg");
			uCubemap[3]= new Texture(f + "top.jpg");
			uCubemap[4]= new Texture(f + "front.jpg");
			uCubemap[5]= new Texture(f + "back.jpg");
			int uCubemapID = gl.getUniformLocation("uCubemap");
			gl.glUniforms(uCubemapID, uCubemap);
...
//		}
	...
	public static void main(String[] s) {
		ApplicationCubemap app=new ApplicationCubemap();
		app.setVisible(true);
	...
	void init(){
		...
		ComponentAdapter adapter = new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				Container contentPane=ApplicationCubemap.this.getContentPane();
