...
//        // Load earth texture.
//        try {
//        	InputStream stream = getClass().getResourceAsStream("unshaded1024.jpg");
...
//        try {
//            InputStream stream =getClass().getResourceAsStream("unshaded1024.jpg"); //new FileInputStream("unshaded1024.jpg");
//            TextureData data = TextureIO.newTextureData(stream, false, "jpg");
...
//        
//        //创建贴图。为什么贴图无法显示？
//        //model.creatTexture(gl, glu,new ArrayList<int[]>());
//        // Start animator.
...
//        
//        
//        long elapsedTime=new Date().getTime() -currentTime.getTime();
//        //model.updateByTime(elapsedTime,gl);
